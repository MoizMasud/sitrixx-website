...
function ContactPageContent() {
  ...
  return (
    <div className="min-h-screen bg-background w-full overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-16 px-4 overflow-hidden w-full">
        <motion.div 
        ...
        >
          ...
          <motion.h1 
            className="text-5xl md:text-7xl font-black mb-8 tracking-tighter bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent"
          ...
          <motion.p 
            className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto font-light leading-relaxed px-4"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="px-4 pb-32 w-full overflow-x-hidden">
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full" style={{ marginTop: '6.8rem' }}>
            {/* Contact Information */}
            <motion.div
            ...
            >
              <div className="space-y-8 w-full">
                <div>
                  <h2 className="text-2xl md:text-3xl font-black mb-4 tracking-tight text-foreground">Connect With Us</h2>
                ...
                <motion.div 
                  className="bg-gradient-to-br from-card via-card to-primary/5 border-2 rounded-3xl shadow-2xl overflow-hidden w-full"
                    ...
                    <div className="space-y-6">
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-sm text-muted-foreground font-light break-words">sitrixx1@gmail.com</div>
                        </div>
                      </motion.div>
                ...
                <motion.div 
                  className="bg-gradient-to-br from-primary/10 to-purple-500/10 border-2 rounded-3xl shadow-xl p-6 md:p-8 w-full"
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.3 }}
                >
                  <h3 className="font-bold text-base md:text-lg mb-3 text-foreground">Quick Response</h3>
            ...
            <motion.div
              ...
              className="lg:col-span-2 w-full" style={{ marginTop: '6.8rem' }}
            >
              <div className="bg-gradient-to-br from-card via-card to-muted/20 border-2 rounded-3xl shadow-2xl overflow-hidden w-full">
                <div className="p-6 md:p-10">
                  {submitted ? (
                    ...
                    >
                      ...
                      <h3 className="text-2xl md:text-3xl font-black mb-3 tracking-tight text-foreground">Thank You!</h3>
                      <p className="text-muted-foreground text-base md:text-lg font-light px-4">
                        We've received your message and will get back to you at <strong className="break-words">{formData.email}</strong> within 24 hours.
                      </p>
                    </motion.div>
                  ) : (
                    <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 w-full">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 w-full">
                        <div className="space-y-3 w-full">
                          <Label htmlFor="name" className="text-sm md:text-base font-bold text-foreground">Full Name *</Label>
                          <div className="relative w-full">
                            ...
                            <Input
                              ...
                              className="pl-12 h-12 md:h-14 rounded-2xl border-2 text-sm md:text-base shadow-md focus:shadow-xl transition-all w-full"
                              required
                        ...
                        <div className="space-y-3 w-full">
                          <Label htmlFor="email" className="text-sm md:text-base font-bold text-foreground">Email Address *</Label>
                          <div className="relative w-full">
                        ...
                        <div className="space-y-3 w-full">
                          <Label htmlFor="phone" className="text-sm md:text-base font-bold text-foreground">Phone Number</Label>
                          <div className="relative w-full">
                        ...
                        <div className="space-y-3 w-full">
                          <Label htmlFor="service" className="text-sm md:text-base font-bold text-foreground">Package *</Label>
                          <select
                            id="service"
                            name="service"
                            value={formData.service}
                            onChange={handleInputChange as any}
                            className="w-full h-12 md:h-14 px-4 rounded-2xl border-2 border-input bg-background text-foreground text-sm md:text-base shadow-md focus:shadow-xl transition-all"
                            required
                            disabled={isSubmitting}
                          >
                      ...
                      <div className="space-y-3 w-full">
                        <Label htmlFor="message" className="text-sm md:text-base font-bold text-foreground">Tell Us About Your Project *</Label>
                        <Textarea
                          id="message"
                          name="message"
                          ...
                          onChange={handleInputChange}
                          rows={6}
                          className="rounded-2xl border-2 text-sm md:text-base shadow-md focus:shadow-xl transition-all resize-none w-full"
                          required
                          disabled={isSubmitting}
                        />
                      </div>
                      ...
                      <div className="flex justify-end w-full">
                        <Button 
                          type="submit" 
                          size="lg" 
                          className="w-full md:w-auto md:min-w-[240px] group rounded-2xl h-12 md:h-14 font-bold shadow-2xl text-base md:text-lg bg-gradient-to-r from-primary to-purple-600 hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                          disabled={isSubmitting}
                        >
                          {isSubmitting ? (
                            <>
      ...
      {/* Footer */}
      <footer className="py-20 px-4 w-full">
        <motion.div 
          initial={{ opacity: 0 }}
        ...
        >
          <motion.div 
            className="text-2xl md:text-3xl font-black mb-4 text-foreground"
          ...
          <p className="text-sm text-muted-foreground mt-3 font-light px-4">
